...
<html lang="en">
  <head>
  	<title>Espace Sexe/Etudiant</title>
    <meta charset="utf-8">
    ...
    <script type="text/javascript">
      ...
      function drawChart() {
        ...
        var data = google.visualization.arrayToDataTable([
         ...
         <?php
         $sql = "SELECT distinct sexe, count(id)  FROM etudiant GROUP BY sexe ";
         $fire = mysqli_query($con,$sql);
          while ($result = mysqli_fetch_assoc($fire)) {
            echo"['".$result['sexe']."',".$result['count(id)']."],";
          }
  ...
  <div class="wrapper d-flex align-items-stretch">
			<nav id="sidebar">
	  		...
	  		<div class="img bg-wrap text-center py-4" style="background-image: url(images/bg_1.jpg);">
                ...
                <li >
                    <a href="index1.php"><span class="fa fa-graduation-cap mr-3"></span> Filiere</a>
                </li>
  ...
  .supprimer{
    ...
    <?php
        ...
        ?>
        <form method="GET" action="controller/load3.php" >
                <fieldset>

                        Selectionner le sexe : <select name="sexe" >
                            <?php
                            foreach ($es->findSexes() as $s) {
                                ?>
       ...
       <br> <hr><br>
         ...
         <table border="1" class="tab">
            ...
            <tbody>
                ...
                $es = new EtudiantService();
                if(isset($_GET['sexe']))
                foreach ($es->findEtudiantsBySexe($_GET['sexe']) as $e) {
                    ?>
                    <tr>
                        ...
                        <td style="color: #153f00; font-weight: bold;"><?php echo $e->getSexe(); ?></td>
